...
const AdminOrders = () => {
  ...
  return (
    ...
    <div className='row dashboard m-5'style={{backgroundColor:"#f5deb3"}}>
            ...
            orders?.map((o,i)=>{
              return(
                <div className='border shadow'>
                  <table className='table' style={{borderStyle:"solid", borderColor:" black",backgroundColor:"#f5deb3"}}>
                   <thead>
                    <tr>
                      <th scope="col">#</th>
                  ...
                  {
                    o?.products?.map((p,i) => (
                        <div className='row mb-2 p-3 card flex-row' key={p._id} style={{backgroundColor:"cyan"}}>
